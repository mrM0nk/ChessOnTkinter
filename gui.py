...
def инициализация_интерфейса(info_panel):
    """Функция для инициализации окна и полотна, а также боковой панели \n
    Разработчик: Сухоруков
    """
...
def номер_цвета_доски():
    """Функция возвращает номер цвета доски \n
    Разработчик: Сухоруков
    """
...
def отрисовка_доски():
    """Функция рисует полотно доски, клетки и подписи координат \n
    Разработчик: Сухоруков
    """
...
def get_delay():
    """Функция возвращет float значение задержки анимации для отрисоки \n
    Разработчик: Сухоруков
    """
...
def выбор_фигуры():
    """Функция возвращает выбранную фигуру \n
    Разработчик: Сухоруков
    """
...
def очистка_доски():
    """Функция пересоздает окно, полотно и боковую панель при изменении настроек \n
    Разработчик: Сухоруков
    """
...
def сброс_старт_финиш():
    """Функция сбрасывает значения глобальных переменных до NONE для возможности повторного использования расчетов хода фигуры \n
    Разработчик: Сухоруков
    """
...
def номер_фона():
    """Функция озвращает номер выбранного фонового рисунка \n
    Разработчик: Сухоруков
    """
...
def подсветить_клетки(коорд_свободных_клеток):
    """Функция для подсветки клеток при перемещении фигур \n
    Разработчик: Сухоруков
    """
...
def позиция(event):
    """Функция для подсветки стартовой и финишной клетки \n
    Разработчик: Сухоруков
    """
...
def перемести_фигуру(короткий_путь, фигура="КоньБ", номера_ходов=False):
    """Функция для отображения анимации перемещения фигуры \n
    Разработчик: Сухоруков
    """
