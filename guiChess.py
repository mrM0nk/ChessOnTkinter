...
def отрисовка_шахмат(холст, отступ_x, отступ_y, клетка):
    холст.update()
    time.sleep(1)

    def отрисовка_черных_шахмат(холст, отступ_x, отступ_y, клетка):
    ...
    def отрисовка_белых_шахмат(холст, отступ_x, отступ_y, клетка):
    ...
    отрисовка_черных_шахмат(холст, отступ_x, отступ_y, клетка)
    отрисовка_белых_шахмат(холст, отступ_x, отступ_y, клетка)
...
def нарисовать_фигуру(холст, отступ_x, отступ_y, клетка, фигуры, координата_x, координата_y, фигура):
...
def ввод_координат_коню():
    холст.create_text(отступ_x + клетка * 4, отступ_y + клетка * 9, font=("Purisa", клетка // 2),
    ...
    холст.create_rectangle(отступ_x + старт_x * клетка - клетка, отступ_y - старт_y * клетка + клетка * 8,
                           ...
                           outline="green")
    холст.create_text(отступ_x + клетка * 4, отступ_y + клетка * 19 / 2, font=("Purisa", клетка // 2),
...
# отрисовка_шахмат(холст, отступ_x, отступ_y, клетка)
'''##нарисовать_фигуру (холст, отступ_x, отступ_y, клетка, фигуры, координата_x, координата_y, фигура)
##x_мыши, y_мыши = get_mouse()'''
